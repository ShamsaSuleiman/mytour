...
import 'package:mytour/services/orderservice.dart';
import 'Receipt.dart';
import 'api.dart';
...
class Malipo extends StatefulWidget {
  ...
  Malipo(this.customer_id, this.packages_id);



  @override
  _MalipoState createState() => _MalipoState();
}
...
//function to check username or password is correct or not
  startLogin() async {
    String apiurl ="c/control/"+controlno; //api url
    ...
    if(response.statusCode == 200){
      ...
      if(jsondata["controlno"].toString() == null){
        ...
        if(jsondata["controlno"].toString() != null){
          OrderService.makeOrder(widget.packages_id, widget.customer_id);
          setState(() {
            error = false;
            showprogress = false;
          ...
          Map results = await Navigator.of(context)
            ...
            return Recieptt(widget.customer_id, widget.packages_id);
          })
          );
        ...
        slivers: <Widget>[
          SliverAppBar(
            // ignore: prefer_const_literals_to_create_immutables
              actions: <Widget>[],
              title: Text(""+widget.packages_id.toString()),
              ...
              Container(
                ...
                child: FlatButton(
                  onPressed: () {
                    ...
                    startLogin();
                   // Navigator.of(context).push(MaterialPageRoute(builder: (context)=>Malipo(controlno: _controlno.text)));
                  },
                  child: Text(
                    'Confirm',
